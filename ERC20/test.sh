...
############################## Test Case#4 ##########################################
# Invoke again in the context of Dfarmretail org
set_org_context     dfarmretail

# Install the chaincode on Dfarmretail peer
chain_install

set_test_case   'From Dfarmretail Peer also Sam balance should be 10'
CC_QUERY_ARGS='{"Args":["balanceOf","sam"]}' 
chain_query
